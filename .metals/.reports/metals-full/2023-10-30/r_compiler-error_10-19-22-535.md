...
### file%3A%2F%2F%2Fhome%2Fzcy%2FchiselProj%2FMyChisel%2Fmac.scala:21: error: identifier expected but ) found
    c_reg := Mux(io.done === true.B, io.in_c, mul.)
                                                  ^
...
class macUnit extends Module {
    ...
    mul.MultiplierOutputBundle.multiplier  := io.in_b
